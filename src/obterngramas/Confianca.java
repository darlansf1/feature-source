...
public class Confianca {
    ...
    public Confianca(ArrayList<File> filesIn, ArrayList<File> filesOut, Float supMin, boolean repetir, Float confMin, int rank){
