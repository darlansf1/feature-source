...
public class MutualInformation {
    ...
    public MutualInformation(ArrayList<File> filesIn, ArrayList<File> filesOut, Float supMin, boolean repetir, Float yuleMin, int rank){
                ...
                while((line = fileRules.readLine())!=null){
                    ...
                    if(suporte >= supMin){
                        ...
                        try{
                            ...
                            double mutual2 = (hashSup.get(corpo) - suporte) * ((Math.log10(((hashSup.get(corpo) - suporte)/((hashSup.get(corpo))*(1-hashSup.get(cabeca))))))/0.301);
                            double mutual3 = (hashSup.get(cabeca) - suporte) * ((Math.log10(((hashSup.get(cabeca) - suporte)/((hashSup.get(cabeca))*(1-hashSup.get(corpo))))))/0.301);
                            double mutual4 = (1 - hashSup.get(corpo) - hashSup.get(cabeca) + suporte) * ((Math.log10(((1 - hashSup.get(corpo) - hashSup.get(cabeca) + suporte)/((1 - hashSup.get(cabeca))*(1-hashSup.get(corpo))))))/0.301);
