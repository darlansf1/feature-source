 ...
 * @author ragero
 */
public class LinearCorrelationMedia {

    public LinearCorrelationMedia(ArrayList<File> filesIn, ArrayList<File> filesOut, Float supMin, boolean repetir, Float yuleMin, int rank){
            ...
            try{
                ...
                if(rank > 0){
                    ...
                    for(int j=0;j<itemsets.size();j++){
                        ...
                        if(linha.contains(" ")){
                            Double valCorr = hashCorr.get(linha);
                            corrMed = corrMed + valCorr;
                            kitemsets++;
                            //System.out.println("Itemset: " + linha + "  Confianca: " + confRegra);
                        }
                    }

                    System.out.println("Total: " + corrMed);
                    corrMed = (float)corrMed/(float)kitemsets;            
                    System.out.println("Correlacao Media: " + corrMed + "--------------------------------------------------");
