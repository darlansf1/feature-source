 ...
 * @author ragero
 */
public class GiniMedio {

    public GiniMedio(ArrayList<File> filesIn, ArrayList<File> filesOut, Float supMin, boolean repetir, Float yuleMin, int rank){
        ...
        for(int i=0;i<filesIn.size();i++){
            ...
            try{
                ...
                for(int j=0;j<itemsets.size();j++){
                    ...
                    if(linha.contains(" ")){
                        Double valGini = hashGini.get(linha);
                        giniMed = giniMed + valGini;
                        kitemsets++;
                        //System.out.println("Itemset: " + linha + "  Confianca: " + confRegra);
                    }
                }
                
                System.out.println("Total: " + giniMed);
                giniMed = (float)giniMed/(float)kitemsets;            
                System.out.println("Gini Index Medio: " + giniMed + "--------------------------------------------------");
